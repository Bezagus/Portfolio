  ...
  return (
    <div id="portfolio">
      ...
      <span className="section__subtitle nocopy">
        {URLactual === '/en' ? `My Projects` : `Mis Proyectos`}
      </span>

      <div className="portfolio__container container grid">
        <div className="portfolio__content">
          <a
            href="https://youtu.be/gUPLw4EThp4"
            target="_blank"
            rel="noreferrer"
          >
            <img
      ...
      <div className="portfolio__container container grid">
        <div className="portfolio__content">
          <a
            href="https://henrybienesraices.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
            <img
              src={img1}
              alt="Henry Bienes Raices"
              className="portfolio__content-img"
            />
          </a>
          <div className="portfiolio__content">
            <div>
              ...
              <h3 className="services__title">
                Fullstack <br />{' '}
                {URLactual === '/en' ? `Real estate` : `Bienes Raices`}
              </h3>
            </div>
      ...
      >
        <div className="services__modal-content">
          ...
          <h3 className="services__modal-title">
            {URLactual === '/en'
              ? `Group Project (Henry Real Estate)`
              : `Proyecto Grupla (Henry Bienes Raices)`}
          </h3>
          <p className="services__modal-description">
            {URLactual === '/en'
              ? `This project was created in collaboration with a group of 8 members, and 
            ...
            <br />
            {URLactual === '/en' ? `Assigned role` : `Rol Asignado`}: Full Stack
            <br />
            ...
            Front-End:
            <br />
            React, Redux, Formik, Auth0, Sweetalert2, MercadoPago,
            {URLactual === '/en' ? `among others` : `Entre Otras`}
            <br />
            Back-End:
            <br />
            Expeess, Jsonwebtoken, MercadoPago, Cookies, Entre Otras
            <br />
            {URLactual === '/en' ? `Database` : `Base de Datos`}: <br />
            SQL (Postgres) Sequielize
            <br />
            {URLactual === '/en' ? `Tools` : `Herramientas`}: <br />
            {URLactual === '/en' ? `Methodology` : `Metodologia`} Scrum, Figma,
            Trello, Discord, Github
          </p>
          <a
            href="https://henrybienesraices.vercel.app/"
            target="_blank"
      ...
      >
        <div className="services__modal-content">
          ...
          <p className="services__modal-description">
            {URLactual === '/en'
              ? `This project is created with the purpose of enhancing my personal brand and showcasing my work to companies, taking on the role of a front-end developer.`
            ...
            :<br />
            JavaScript, React JS, HTML, CSS, React Icon, Email Js
            <br />
      ...
      <div className="portfolio__container container grid">
        ...
        >
          <div className="services__modal-content">
            ...
            <p className="services__modal-description">
              {URLactual === '/en'
                ? `This project is created with the aim of showcasing my skills in action. I previously mentioned the technologies I master, and now with this project, I aim to demonstrate various projects, from the simplest to those that require more than one technology.`
                : `Este Pryecto esta creado con el objetivo de Mostrar Mis Habilidades en Accion, Anteriormente Mencione 
                        ...
                        los Proyectos que requieren de mas de una Tecnologia. `}
              <br />
            </p>
            <a
              href="https://agustin-benitez-proyectos.vercel.app/"
              target="_blank"
              rel="noreferrer"
              className="services__button"
              onClick={() => handleClick(1)}
